...
class Smsgateway {
    ...
    function sendSMS($send_to,$template='',$detail)  {
    ...
    function sentRegisterSMS($id, $send_to,$template) {
        $sms_detail = $this->_CI->smsconfig_model->getActiveSMS();
    ...
    function sentAddFeeSMS($detail, $template) {
    ...
    function sentAbsentStudentSMS($detail,$template) {
        $sms_detail = $this->_CI->smsconfig_model->getActiveSMS();
    ...
    function sentExamResultSMS($detail,$template) {
