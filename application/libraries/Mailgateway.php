...
class Mailgateway {
   ...
   function sentMail($sender_details,$template,$subject) {
    ...
    function sentRegisterMail($id, $send_to,$template) {
    ...
    function sendLoginCredential($chk_mail_sms, $sender_details,$template) {
    ...
    function sentAddFeeMail($detail, $template) {
    ...
    function sentExamResultMail($detail,$template) {
    ...
    function sentAbsentStudentMail($detail,$template) {
