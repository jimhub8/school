                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/marksheet') ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('exam')." ".$this->lang->line('center'); ?></label><small class="req"> *</small>
                                ...
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('printing')." ".$this->lang->line('date');?></label><small class="req"> *</small>
