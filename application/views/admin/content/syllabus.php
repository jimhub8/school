                ...
                <div class="box box-primary" id="syllabus">
                    ...
                    <div class="box-body">
                        ...
                        <div class="mailbox-messages">
                            ...
                            ?>
                                                <a href="<?php echo base_url(); ?>admin/content/deleteassignment/<?php echo $data['id'] ?>/syllabus"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
