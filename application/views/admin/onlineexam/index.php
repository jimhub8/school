...
foreach ($questionList as $subject_key => $subject_value) {
    ?>
                                      ...
                                      <td class="text text-center"><?php echo ($subject_value->publish_result == 1) ? "<i class='fa fa-check-square-o'></i>" : "<i class='fa fa-exclamation-circle'></i>"; ?></td>
                                            ...
                                            <td class="text-right">
                                                <?php if($this->rbac->hasPrivilege('online_assign_view_student','can_view')){ ?>
                                  <a href="<?php echo base_url(); ?>admin/onlineexam/assign/<?php echo $subject_value->id ?>"
                                            ...
                                            if($this->rbac->hasPrivilege('add_questions_in_exam','can_view')){
                                                ...
                                                ?>
                                                 <button type="button" class="btn btn-default btn-xs question-btn-edit" data-toggle="tooltip" id="load" data-recordid="<?php echo $subject_value->id; ?>"  data-loading-text="<i class='fa fa-spinner fa-spin'></i>"><i class="fa fa-pencil"></i></button>
                                                <?php
                                            }
                                            if($this->rbac->hasPrivilege('online_examination','can_delete')){ ?>
                                                <a href="<?php echo base_url(); ?>admin/onlineexam/delete/<?php echo $subject_value->id; ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
