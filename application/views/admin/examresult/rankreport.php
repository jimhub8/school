                    ...
                    if (isset($studentList)) {
                        ...
                        <div class="box-body">
                            <div class="table-responsive no-padding">
                                 <div class="download_label"><?php  ?> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('list'); ?></div>
                                ...
                                if (empty($studentList)) {
                                    ...
                                    if ($student_array['subject_added']) {
                                        aasort($student_list_array, "percentage", SORT_DESC);
                                    }
