                                        ...
                                        <td ><?php if($value['status']==0){ echo $this->lang->line('pending'); }else{ echo  $this->lang->line('approve'); }?>
                                               ...
                                               <td><?php echo $value['staff_name']." ".$value['surname'];?></td>
                                                <td class="text-right">
                                                    ...
                                                    if($value['status']==1){
                                                        ?>
                                                        <a href="<?php echo base_url();?>admin/approve_leave/status/<?php echo $value['id'] ?>/0"  class="btn btn-default btn-xs" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('disapprove')?>"> <i class="fa fa-times"  aria-hidden="true"></i></a>
                                                        <?php
                                                    }else{
                                                        ?>
                                                        <a href="<?php echo base_url();?>admin/approve_leave/status/<?php echo $value['id'] ?>/1" class="btn btn-default btn-xs" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('approve')?>"><i class="fa fa-check" aria-hidden="true"></i></a>
                                                        <?php
                                                    }
                                                    ?>
                                                     <?php 
                                                    ...
                                                    if($value['docs']!=''){
                                                        ?>
                                                          <a href="<?php echo base_url();?>admin/approve_leave/download/<?php echo $value['docs']?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="<?php echo base_url(); ?>admin/approve_leave/remove_leave/<?php echo $value['id'];?>" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete')?>" class="btn btn-default btn-xs"><i class="fa fa-remove" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');"></i> </a>
