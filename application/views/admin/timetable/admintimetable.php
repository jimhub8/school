        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="<?php echo site_url('admin/timetable/getteachertimetable'); ?>" id="getTimetable">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4"> 
                             <div class="form-group">
                                <label style="display: block; visibility:hidden;"><?php echo $this->lang->line('teacher') ?></label>
