<div class="row clearfix">
    <div class="col-md-12 column">
        <a id="add_row" class="addrow btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('new'); ?></a>
                ...
                <tbody>
                    ...
                    if (!empty($prev_record)) {
                        ...
                        <tr id='addr0'>
                            ...
                            <td><button class="ibtnDel btn btn-danger btn-sm btn-danger"> <i class="fa fa-trash"></i></button></td>
