                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    <?php if (empty($admitcardList)) {
                                        ...
                                        $count = 1;
                                        foreach ($admitcardList as $eachadmitcard) {
                                            ?>
                                            <tr>
                                                <td class="mailbox-name">
                                                    <a style="cursor: pointer;" class="view_data" id="<?php echo $eachadmitcard->id ?>" data-toggle="popover" class="detail_popover" ><?php echo $eachadmitcard->template; ?></a>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php if ($eachadmitcard->background_img != '' && !is_null($eachadmitcard->background_img)) { ?>
                                                        <img src="<?php echo base_url('uploads/admit_card/') ?><?php echo $eachadmitcard->background_img ?>" width="40">
                                                    <?php } else { ?>
                                                ...
                                                <td class="mailbox-date text-right no-print">
                                                    <a id="<?php echo $eachadmitcard->id ?>" class="btn btn-default btn-xs view_data" title="<?php echo $this->lang->line('view'); ?>">
                                                        <i class="fa fa-reorder"></i>
                                                    </a>
                                                    <?php
                                                    if ($this->rbac->hasPrivilege('student_certificate', 'can_edit')) {
                                                        ?>
                                                        <a href="<?php echo site_url('admin/admitcard/edit/'.$eachadmitcard->id); ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('student_certificate', 'can_delete')) {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>admin/certificate/delete/<?php echo $eachadmitcard->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
