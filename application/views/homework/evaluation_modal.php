                            ...
                            <ul multiple=""  class="list-group" id="slist">
                                ...
                                foreach ($studentlist as $key => $value) {
                                    ...
                                    <li class="list-group-item <?php echo ($active_status) ? "active" : "" ?>">
                                        <div class="checkbox">
                                            <label><input type="checkBox" <?php echo ($active_status) ? "checked='checked'" : "" ?>name="student_list[<?php echo $value["id"] ?>]" value="<?php echo $value["homework_evaluation_id"] ?>"><?php echo $value["firstname"] ?></label>
                                        </div>
