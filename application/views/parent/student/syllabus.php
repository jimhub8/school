                                    ...
                                    foreach ($list as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date text-right">
                                                <a href="<?php echo base_url(); ?>parent/parents/downloadSchool_content/<?php echo $data['file'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
