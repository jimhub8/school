                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right"><?php echo $this->lang->line('rating'); ?></th>
                                            ...
                                            <tr>
                                               ...
                                               $stage=(int) ($avg_rate[$teacher[0]->staff_id]);
                                                ...
                                                <td class=""><center>
                                                    ...
                                                    if($reted=='0'){?>
                                                    <a onclick="rating('<?php echo $teacher[0]->staff_id?>')" ><i class="fa fa-plus"></i></a><?php } ?></center></td>
                                            </tr>
                                            <?php
                                        }
                                        $count++;
