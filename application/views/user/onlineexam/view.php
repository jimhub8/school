                    ...
                    <div class="box-body">
                        ...
                        if (!empty($online_exam_validate)) {
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-sm-2"><?php  echo $this->lang->line('total')." ".$this->lang->line('questions')?></dt>
            ...
            <div class="modal-dialog modal-dialogfullwidth">
                ...
                <div class="modal-content modal-contentfull">
                    <div class="modal-header">
                        ...
                        <div class="questionlogo"><img src="<?php echo base_url(); ?>uploads/school_content/logo/<?php $this->setting_model->getAdminsmalllogo();?>" alt="<?php echo $this->customlib->getAppName() ?>" /></div>
                    </div>
                    <div class="exambgtop">
