                    ...
                    <div class="box-body">
                      ...
                      <?php
                            ...
                            foreach ($examquestion as $question_key => $question_value) {
                                ?>
                                <fieldset>
                                    <h2><?php echo $this->lang->line('question');?> :<?php echo $counter; ?></h2>
                                    ...
                                    if ($counter == 1 && $counter == $total_count) {
                                        ?>
                                        <input type="submit" name="submit" class="submit btn btn-success" value="<?php echo $this->lang->line('submit'); ?>" />
                                        <?php
                                    }elseif ($counter ==1) {
                                        ?>
                                        
                                        <input type="button" name="next" class="next btn btn-info" value="<?php echo $this->lang->line('next'); ?>" />
                                        <?php

                                    } elseif ($counter !=1 && $counter < $total_count) {
                                        
                                        ?>
                                        <input type="button" name="previous" class="previous btn btn-default" value="<?php echo $this->lang->line('previous'); ?>" />
                                        <input type="button" name="next" class="next btn btn-info" value="<?php echo $this->lang->line('next'); ?>" />
                                        <?php
